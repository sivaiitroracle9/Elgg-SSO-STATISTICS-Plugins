...
/*
 * A wraper class for FacebookRedirectLoginHelper. Customised for Elgg Framework.
* */

namespace Facebook;

class FacebookRedirectLoginHelperElgg {
	...
	{
		return $this->getCode() && isset(get_input('state'))
		&& get_input('state') == $this->state;
	}
	...
	{
		return isset(get_input('code')) ? get_input('code') : null;
	}
